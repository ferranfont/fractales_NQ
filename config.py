...
USE_TIME_IN_MARKET_JSON_OPTIMIZATION_FILE = True   # True = load duration from JSON by entry hour, False = use fixed TIME_IN_MARKET_MINUTES             # True = use time-based exit, False = use TP/SL exit
...
MAX_SL_ALLOWED_IN_TIME_IN_MARKET = 100              # Maximum stop loss allowed in points when USE_MAX_SL_ALLOWED_IN_TIME_IN_MARKET = True
