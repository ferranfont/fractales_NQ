"""Quick script to show pullback trades"""
import pandas as pd

df = pd.read_csv('outputs/trading/tracking_record_vwap_pullback_20251104.csv', sep=';', decimal=',')

print('\n=== TRADES VWAP PULLBACK - 20251104 ===\n')
